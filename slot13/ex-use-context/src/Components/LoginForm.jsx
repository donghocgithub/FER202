...
function LoginForm() {
  ...
  // 5. Sử dụng ThemeContext
  const { theme } = useTheme();

  // 6. Sử dụng ToastContext
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      addToast('Please fix the validation errors.', 'warning', 3000);
      return;
    }
    ...
    try {
      ...
      if (result.ok) {
        ...
        addToast(`Welcome, ${user?.username}!`, 'success', 4000);
  ...
  // 12. Xử lý đóng modal thành công
        ...
        <Row className="justify-content-md-center">
          <Col md={6}>
            <Card style={{ 
              ...
              <Card.Header>
                <h3 className="text-center text-success">Login Successful!</h3>
              </Card.Header>
              <Card.Body>
