// Component LightSwitch sử dụng useState để bật/tắt đèn
import React, { useState } from 'react';
import Button from 'react-bootstrap/Button';

function LightSwitch() {
    // Khởi tạo state: isLightOn là boolean, giá trị ban đầu là false (tắt), setIsLightOn là hàm để cập nhật isLightOn
    ...
    return (
        <div style={{ 
            ...
            backgroundColor: isLightOn ? '#ffe8e8' : '#e8f5e8',
