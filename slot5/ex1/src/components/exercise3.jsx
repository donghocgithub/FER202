export function Exercise3() {
  // Bài 1: Arrow function cơ bản – double & isEven
  const double = (n) => n * 2;
  ...
  const avg = (...nums) => {
    ...
    return parseFloat(
      (validNums.reduce((acc, num) => acc + num, 0) / validNums.length).toFixed(2)
    );
  };
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ border: '1px solid #ccc', padding: '15px', margin: '10px 0' }}>
        ...
        <p>isEven(10): {isEven(10).toString()}</p>
        <p>isEven(7): {isEven(7).toString()}</p>
      </div>

      <div style={{ border: '1px solid #ccc', padding: '15px', margin: '10px 0' }}>
        <h3>2. Rest Parameter</h3>
